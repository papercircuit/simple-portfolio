  ...
  return (
    <div className="my-10 mx-5">
      ...
      <motion.ul
        ...
        animate="visible"
      >
        {repos.slice(0, reposToShow).map(
          (repo) => (
            // we can console.log(repo) to see what data we have access to
            console.log(repo),
            (
              <motion.li
                key={repo.id}
              ...
              >
                ...
                <p className="text-gray-600 mt-2 dark:text-gray-400">
                <em>{new Date(repo.created_at).toLocaleString("en-US", { timeZone: "UTC", month: "short", day: "numeric", year: "numeric"
             })}</em>
                </p>
              </motion.li>
            )
